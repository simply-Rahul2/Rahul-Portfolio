            ...
            <div className="ml-10 flex items-baseline space-x-1">
              {navItems.map((item) => (
                <a
                  key={item.href}
                  href={item.href}
                  className="text-muted-foreground hover:text-primary px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 hover:bg-primary/5"
                >
                  {item.label}
                </a>
              ))}
          ...
          <div className="hidden md:flex items-center space-x-2">
            {socialLinks.map((link) => (
              <a
                ...
                className="text-muted-foreground hover:text-primary transition-colors duration-200 p-2 hover:bg-primary/5 rounded-lg"
              >
